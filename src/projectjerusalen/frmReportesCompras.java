 ...
 * @author Josue
 */
public class frmReportesCompras extends javax.swing.JFrame {

    compraLogic cm = new compraLogic();
    int idCompra = 0;
    ...
    private void initComponents() {
        ...
        tableCompra.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Proveedor", "Usuario", "Tipo Compra", "Fecha", "Total"
            }
        ));
    ...
    private void tableCompraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCompraMouseClicked
        int select = tableCompra.getSelectedRow();
        idCompra = Integer.parseInt(tableCompra.getValueAt(select,0).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReportesCompras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReportesCompras().setVisible(true);
            }
        });
    }
