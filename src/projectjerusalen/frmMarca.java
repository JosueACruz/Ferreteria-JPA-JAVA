...
public class frmMarca extends javax.swing.JFrame {
    ...
    private MarcaLogic MarLog = new MarcaLogic();
    int idMarca=-1;
    ...
    private void initComponents() {
        ...
        txtMarca.setBackground(new java.awt.Color(22, 33, 62));
        txtMarca.setForeground(new java.awt.Color(255, 255, 255));
        txtMarca.setBordeColorFocus(new java.awt.Color(255, 255, 255));
        txtMarca.setBotonColor(new java.awt.Color(255, 255, 255));
        txtMarca.setPlaceholder("");
        txtMarca.setSelectionColor(new java.awt.Color(0, 112, 192));
        jPanel1.add(txtMarca, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 170, 320, -1));
        ...
        jPanel1.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 260, 150, 40));
        ...
        jPanel1.add(btnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 260, 150, 40));
    ...
    private void tableMarcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMarcaMouseClicked
        int select=tableMarca.getSelectedRow();
        idMarca=Integer.parseInt(tableMarca.getValueAt(select, 0).toString());
        txtMarca.setText(tableMarca.getValueAt(select, 1).toString());
    }//GEN-LAST:event_tableMarcaMouseClicked

    private void mostrarCategorias(){
        MarLog.ListaMarca(tableMarca);
    }
    
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        String nameCat= txtMarca.getText();
        if(nameCat.isEmpty()){
            JOptionPane.showMessageDialog(null,"Debe escribir la categoria");
        }else{
            String mensaje="";
            mensaje=MarLog.insertarMarca(nameCat);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if(idMarca == -1)
        {
            ...
            String mensaje = "";
            mensaje = MarLog.eliminarMarca(idMarca);
            JOptionPane.showMessageDialog(null, mensaje);
            mostrarCategorias();
            idMarca = -1; 
        }
